    ...
    public class SettingsViewModel : ViewModelBase
    {
        ...
        private void LoadPluginInfo()
        {
            ...
            foreach (var plugin in Plugins.PluginManager.Instance.GroupChatPlugins)
            {
                ...
                plugins.Add(new Plugin() { Name = pluginBase.PluginDisplayName, Version = pluginBase.PluginVersion, Type = "Group Chat Plugins" });
            }
            ...
            {
                var pluginBase = plugin as GroupMeClientPlugin.PluginBase;
                plugins.Add(new Plugin() { Name = pluginBase.PluginDisplayName, Version = pluginBase.PluginVersion, Type = "Group Chat Cache Plugins" });
            }
            ...
            {
                var pluginBase = plugin as GroupMeClientPlugin.PluginBase;
                plugins.Add(new Plugin() { Name = pluginBase.PluginDisplayName, Version = pluginBase.PluginVersion, Type = "Message Effect Plugins" });
            }

            this.InstalledPlugins = new DataGridCollectionView(plugins);
            this.InstalledPlugins.GroupDescriptions.Add(new DataGridPathGroupDescription("Type"));
        }
